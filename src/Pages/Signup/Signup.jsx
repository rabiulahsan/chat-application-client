        ...
        <div className="card bg-white shadow-md rounded px-10 pt-8 pb-8 mb-4 w-1/4">
          <form onSubmit={handleSubmit(onSubmit)} className="">
            <div className="form-control">
              <label className="label block mb-1 text-gray-700 text-sm font-bold">
              ...
              <input
                ...
                name="name"
                placeholder="Name"
                className="mb-4 shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight input input-bordered focus:outline-none focus:shadow-outline"
              />
              {errors.name && (
            ...
            <div className="form-control">
              <label className="mb-1 label block text-gray-700 text-sm font-bold">
            ...
            <div className="form-control mt-6">
              <input
                className="cursor-pointer w-full text-center bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
                type="submit"
                value="Sign Up"
              />
            </div>
